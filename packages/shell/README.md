...
Check the [package documentation](https://docs.ckbccc.com/docs/packages/core-packages/shell) and [API reference](https://api.ckbccc.com/modules/_ckb-ccc_shell.index) for more details.
