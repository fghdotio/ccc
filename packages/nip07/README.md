...
Check the [package documentation](https://docs.ckbccc.com/docs/packages/wallet-integrations/nip07) and [API reference](https://api.ckbccc.com/modules/_ckb-ccc_nip07.index) for more details.
