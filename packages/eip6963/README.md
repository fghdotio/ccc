...
Check the [package documentation](https://docs.ckbccc.com/docs/packages/wallet-integrations/eip6963) and [API reference](https://api.ckbccc.com/modules/_ckb-ccc_eip6963.index) for more details.
