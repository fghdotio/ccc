...
Check the [package documentation](https://docs.ckbccc.com/docs/packages/wallet-integrations/utxo-global) and [API reference](https://api.ckbccc.com/modules/_ckb-ccc_utxo-global.index) for more details.
