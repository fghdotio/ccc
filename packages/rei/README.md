...
Check the [package documentation](https://docs.ckbccc.com/docs/packages/wallet-integrations/rei) and [API reference](https://api.ckbccc.com/modules/_ckb-ccc_rei.index) for more details.
