...
Check the [package documentation](https://docs.ckbccc.com/docs/packages/core-packages/connector) and [API reference](https://api.ckbccc.com/modules/_ckb-ccc_connector.index) for more details.
